...
% 21 May 2013
% ----------------------------------------------------------------------------
function hfssAssignSlave(fid, Name, ObjName, iUStart, iUEnd, Units, Master, ReverseV, Theta0, Phi0)
...
fprintf(fid, '\t"UseScanAngles:=", true, "Theta:=", "%fdeg", "Phi:=", "%fdeg" _\n', Theta0, Phi0);
%fprintf(fid, '\t"UseScanAngles:=", false, "Phase:=", "%fdeg" _\n', Theta0);
fprintf(fid, '\t)\n');
